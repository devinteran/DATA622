...
gender_loan_status_perct[1,] <- gender_loan_status_perct[1,]/13
gender_loan_status_perct[2,] <- gender_loan_status_perct[2,]/112
gender_loan_status_perct[3,] <- gender_loan_status_perct[3,]/489
...
selfemp_loan_status_perct[1,] <- selfemp_loan_status_perct[1,]/32
selfemp_loan_status_perct[2,] <- selfemp_loan_status_perct[2,]/500
selfemp_loan_status_perct[3,] <- selfemp_loan_status_perct[3,]/82
